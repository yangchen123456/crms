...
<table border="0" align="center" width="40%" style="margin-left: 100px;">
	...
	<tr>
		<td>客户生日</td>
		<td>
			<input value="${crms.birthday}" type="text" name="birthday" id="birthday" readonly="readonly"/>
		</td>
		<td>
	...
	<tr>
		<td>手机</td>
		<td>
			<input value="${crms.cellphone}" type="text" name="cellphone"/>
		</td>
		<td>
	...
	<tr>
		<td>邮箱</td>
		<td>
			<input value="${crms.email}" type="text" name="email"/>
		</td>
		<td>
